...
tdrsim_eg_genmatched = [
    ...
    #     sim_eg_match_ee_selections, selections.gen_ee_selections),
    ...
    plotters.EGGenMatchPlotter(
        ...
        sim_eg_match_ee_selections, selections.gen_ee_tk_selections),
    plotters.EGGenMatchPlotter(
...
l1tc_eg_genmatched = [
    plotters.EGGenMatchPlotter(
        ...
        l1tc_match_ee_selections, selections.gen_ee_selections),
    plotters.EGGenMatchPlotter(
        collections.tkeles_EE_pfnf, collections.gen_parts,
        l1tc_match_ee_selections, selections.gen_ee_tk_selections),
    plotters.EGGenMatchPlotter(
...
l1tc_fw_eg_genmatched = [
    plotters.EGGenMatchPlotter(
        collections.egs_EE_pfnf, collections.gen_parts,
        l1tc_fw_match_ee_selections, selections.gen_ee_selections),
    plotters.EGGenMatchPlotter(
        collections.tkeles_EE_pfnf, collections.gen_parts,
        l1tc_fw_match_ee_selections, selections.gen_ee_tk_selections),
    plotters.EGGenMatchPlotter(
        collections.tkeles_EB_pfnf, collections.gen_parts,
        selections.eg_id_pt_eb_selections, selections.gen_eb_selections),
    plotters.EGGenMatchPlotter(
