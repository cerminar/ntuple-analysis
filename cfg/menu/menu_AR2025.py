...
menu_obj_sel = [
    ...
    # ---------- Isolated electrons -
    ((Selector('^EtaEB$')&('^IDTightE$')&('^IsoEleEB$'))|(Selector('^EtaEE$')&('^IDTightE$')&('^IsoEleEE'))).one('MenuEleIso', 'Iso Menu WP'),
    ...
    # ---------- Electrons -
    ((Selector('^EtaEB$')&('^IDTightE$'))|(Selector('^EtaEE$')&('^IDTightE$'))).one('MenuEle', 'Menu WP'),
...
trigger_sel = [
    ...
    (Selector('^MenuSta$')&('^PtSta51')).one('SingleEGEle51', 'SingleEGEle51 |#eta| < 2.4'),
...
diobj_sel = [
    ...
    build_DiObj_selection('DoubleTkEle25-12', 'DoubleTkEle25-12',
                        (Selector('^MenuEleTight$')&('^PtEle25')).one(),
                        (Selector('^MenuEleTight$')&('^PtEle12')).one(),
                        Selector('^Dz1$').one()),
    ...
    build_DiObj_selection('DoubleIsoTkEleStaEG22-12', 'DoubleIsoTkEleStaEG22-12',
                        (Selector('^MenuEleIsoTight$')&('^PtIsoEle22')).one(),
...
diobj_legs_sel = [
    ...
    (Selector('^MenuEleTight$')&('^PtEle25')).one('SingleTkEle25', 'SingleTkEle25'),
    (Selector('^MenuEleTight$')&('^PtEle12')).one('SingleTkEle12', 'SingleTkEle12'),
