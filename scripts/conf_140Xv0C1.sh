...
TARGER_VERSION=140Xv0C1


TARGET_DIR=/Users/cerminar/CERNbox/www/plots/142X_newmodels_${TARGER_VERSION}/
...
#    "plots/histos_doubleele_flat1to100_PU200_egplots_v160A.140Xv0B6.root:142X-int-ell"
   "plots/histos_doubleele_flat1to100_PU200_egplots_v160A.140Xv0B20.root:142X+PR"
   "plots/histos_doubleele_flat1to100_PU200_egplots_v160A.${TARGER_VERSION}.root:151X+PR"
)
...
gen_match_ele_files=(
    ...
    "plots/histos_doubleele_flat1to100_PU200_eg_v200C.140Xv0B20.root:142X+PR"
    "plots/histos_doubleele_flat1to100_PU200_eg_v200C.${TARGER_VERSION}.root:151X+PR"
)
...
nugun_ratemenu_files=(
    ...
    "plots/histos_nugun_alleta_pu200_egratemenu_v200A.140Xv0B20.root:142X+PR"    
    "plots/histos_nugun_alleta_pu200_egratemenu_v200A.${TARGER_VERSION}.root:151X+PR"
)
...
nugun_ratectl2_files=(
    ...
    "plots/histos_nugun_alleta_pu200_egrate_v200A.140Xv0B20.root:142X+PR"    
    "plots/histos_nugun_alleta_pu200_egrate_v200A.${TARGER_VERSION}.root:151X+PR"
)
...
nugun_metrate_files=(
    ...
    "plots/histos_nugun_alleta_pu200_jetmet_rate_v200A.140Xv0B20.root:142X+PR"    
    "plots/histos_nugun_alleta_pu200_jetmet_rate_v200A.${TARGER_VERSION}.root:151X+PR"
)
