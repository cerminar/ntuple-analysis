...
TARGET_VERSION=140Xv0C3


TARGET_DIR=/Users/cerminar/CERNbox/www/plots/151X_newvalib_${TARGET_VERSION}/
...
gen_match_menu_ele_files=(
    ...
    "plots/histos_doubleele_flat1to100_PU200_egmenu_v200D.140Xv0C1.root:152X+PR"
