...
nomatch_ele_files=(
   ...
   "plots/histos_doubleele_flat1to100_PU200_egplots_v160A.140Xv0C5.root:151X+PR"
...
gen_match_ele_files=(
    ...
    "plots/histos_doubleele_flat1to100_PU200_eg_v200D.140Xv0C5.root:152X+PR"
...
gen_match_menu_ele_files=(
    ...
    "plots/histos_doubleele_flat1to100_PU200_egmenu_v200D.140Xv0C5.root:152X+PR"
...
nugun_ratemenu_files=(
    ...
    "plots/histos_nugun_alleta_pu200_egratemenu_v200C.140Xv0C5.root:151X+PR"        
...
nugun_egratecount_files=(
    ...
    "plots/histos_nugun_alleta_pu200_egratecount_v200C.140Xv0C5.root:151X+PR"
...
nugun_ratectl2_files=(
    ...
    "plots/histos_nugun_alleta_pu200_egrate_v200C.140Xv0C5.root:151X+PR"
    "plots/histos_nugun_alleta_pu200_egrate_v200C.${TARGET_VERSION}.root:151X+PR+newWPs"
)


nugun_metrate_files=(
    "plots/histos_nugun_alleta_pu200_jmratemet_v200A.140Xv0D0.root:151X"    
    "plots/histos_nugun_alleta_pu200_jmratemet_v200A.140Xv0C5.root:151X+PR"    
    "plots/histos_nugun_alleta_pu200_jmratemet_v200A.${TARGET_VERSION}.root:151X+PR+newWPs"
)

nugun_jetrate_files=(
    "plots/histos_nugun_alleta_pu200_jmratejets_v200A.140Xv0D0.root:151X"    
    "plots/histos_nugun_alleta_pu200_jmratejets_v200A.140Xv0C5.root:151X+PR"    
    "plots/histos_nugun_alleta_pu200_jmratejets_v200A.${TARGET_VERSION}.root:151X+PR+newWPs"
)

jmratejetstreso_files=(
    "plots/histos_ttbar_PU200_jets_v200C.140Xv0D0.root:151X"
    "plots/histos_ttbar_PU200_jets_v200C.140Xv0C5.root:151X+PR"    
